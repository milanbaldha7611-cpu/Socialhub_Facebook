            ...
            <?php
                ...
                if (mysqli_num_rows($res) > 0) {
                    while($row = mysqli_fetch_assoc($res)) {
                        ...
                        ?>
                        <div class="card" style="padding: 20px; display: flex; align-items: center; justify-content: space-between; margin-bottom: 15px; border-radius: 16px;">
                            <div style="display: flex; align-items: center; gap: 20px;">
                                <a href="<?php echo $frnd_url; ?>">
                                    <img src="<?php echo $profile_img; ?>" alt="User" style="width: 80px; height: 80px; border-radius: 50%; object-fit: cover; border: 3px solid var(--primary-color);">
                                </a>
                                <div>
                            ...
                            <button class="add_friend_btn" 
                                ...
                                data-user-srno="<?php echo $row['srno']; ?>" 
                                data-request-status="not_sent">
                                <img src="icon/add-user.svg" style="height: 18px; filter: invert(1); margin-right: 5px;" alt="Add User"> Add Friend
                            </button>
                        </div>
                        <?php
                    }
